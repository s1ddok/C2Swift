...
_DEVICETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ONLY_FOR_TEST', index=3, number=20901701,
      options=None,
      type=None),
  ],
...
_ARGUMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='floats', full_name='caffe2.Argument.floats', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ints', full_name='caffe2.Argument.ints', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='strings', full_name='caffe2.Argument.strings', index=6,
